                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        ...
                        <div class="form-group {{ $errors->has('monto') ? 'has-error': ''}}">
                            ...
                            <input type="text" autocomplete="off" name="monto" value="{{ $licencia->monto }}"  class="form-control" placeholder="Fecha de conexión y/o lo que compete, máximo 90 caracteres">
